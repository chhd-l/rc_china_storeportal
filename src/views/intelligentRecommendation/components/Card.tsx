...
const IntelligentRecommendation = ({ title, span, Enable, Edit, Details, open }: CardType) => {
  return (
    <div style={{ width: '32%', backgroundColor:'#F5F6F6', borderRadius:'4px' }} className="p-4 relative mt-4 ml-4">
