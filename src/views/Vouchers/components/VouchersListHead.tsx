...
const VouchersListHead = () => {
    return (
        <ContentContainer className="bg-white px-4 VouchersListHead relative">
            <Title className="mb-0" level={5}>Vouchers List</Title>
            <span className="text-xs text-gray-400">Create and manage your own vouchers for your shop and products on Seller Center!</span>
            ...
            <Button className="flex items-center CreateBtn" type="primary" icon={<PlusOutlined />}>
                Create
            </Button>
        </ContentContainer>
    )
